...
{
    printk(KERN_INFO "Loading print_string module...\n");
    print_string("Hello, this is a message from the kernel module!\n");
    return 0;
}

static void __exit print_string_exit(void)
{
    printk(KERN_INFO "Unloading print_string module...\n");
}
...
MODULE_DESCRIPTION("A simple kernel module to print a string to the current tty");
MODULE_VERSION("1.0");