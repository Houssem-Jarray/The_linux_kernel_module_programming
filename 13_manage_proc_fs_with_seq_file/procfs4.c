/*
 * procfs4.c - A lab example for manage the proc file system using the seq_file API
 */
...
MODULE_DESCRIPTION("Manage the /proc file using the seq_file API");
MODULE_VERSION("1.0");
...
static void *my_seq_start(struct seq_file *s, loff_t *pos)
{
    ...
    if (*pos == 0)
    {
        /* yes => return a non null value to begin the equencce */
        return &counter;
    }
